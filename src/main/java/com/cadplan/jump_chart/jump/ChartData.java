...
public class ChartData {
  ...
  Vector<String> possibleNames = new Vector<>();
  String chosenName = "";
  DecimalFormat iformat = new DecimalFormat("#####");


  public ChartData(PlugInContext context, I18N i18n) {
    ...
    if (selectedLayer != null) {
      ...
      do {
        ...
        chartDialog = new ChartDialog(selectedLayer.getName(), attributes, i18n);
      ...
      if (!ChartParams.cancelled) {
        ...
        if (ChartParams.chartType == ChartParams.LABELS || ChartParams.showUnderLabels) {
          ...
          if (!nameFound && pNames.length > 0) {
            String result = (String) JOptionPane.showInputDialog(null,
                i18n.get("JumpChart.message5"), i18n.get("JumpChart.message6"),
        ...
        Iterator<Feature> j = featureList.iterator();
        int count = 0;
        while (j.hasNext()) {
          ...
          try {
            ...
            if (ChartParams.chartType == ChartParams.LABELS && chosenName != null)
          ...
          for (int k = 0; k < attributes.size(); k++) {
            ...
            try {
              ...
              try {
                value = feature.getInteger(index);
                ...
                value = -1.0;
                nameValue = feature.getString(index);
                vtype = "STR";
      ...
      JOptionPane.showMessageDialog(null,
          i18n.get("JumpChart.message1"), "Warning...", JOptionPane.WARNING_MESSAGE);
    }
  }
