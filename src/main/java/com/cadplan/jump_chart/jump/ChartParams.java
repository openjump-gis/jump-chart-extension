...
public class ChartParams {
  ...
  public static void setNames(I18N i18n) {
    typeNames = new String[]{
        i18n.get("JumpChart.Dialog.PieEast"),
        i18n.get("JumpChart.Dialog.PieNorth"),
        i18n.get("JumpChart.Dialog.Bar"),
        i18n.get("JumpChart.Dialog.Column"),
        i18n.get("JumpChart.Dialog.Labels")};
  }
